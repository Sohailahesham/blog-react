...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!validate(registerSchema, form, setErrors)) return;
    try {
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`input input-bordered w-full focus:input-primary transition-all ${errors.username ? "input-error" : ""}`}
            />
            {errors.username && (
              <p className="text-error text-xs mt-0.5">{errors.username}</p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              onChange={handleChange}
              className={`input input-bordered w-full focus:input-primary transition-all ${errors.confirmPassword ? "input-error" : ""}`}
            />
